...
/* --------------------- */
  ...
  case class Rational(numerator: Int = 1, denominator:Int = 1) {
    def +(that: Rational) = Rational(numerator * that.denominator + that.numerator, denominator * that.numerator + that.denominator)
    def -(that: Rational) = Rational(numerator * that.denominator - that.numerator, denominator * that.numerator - that.denominator)
    def *(that: Rational) = Rational(numerator * that.numerator, denominator * that.denominator)
    def /(that: Rational) = this * Rational(that.denominator, that.numerator)
  }
